...
export declare const creditCardPaymentSchema: Joi.ObjectSchema<any>;
...
export declare const validatePayment: (schema: Joi.ObjectSchema) => (req: any, res: any, next: any) => any;
